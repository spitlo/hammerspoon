-- https://github.com/andrewhampton/dotfiles/blob/master/hammerspoon/.hammerspoon/grid.lua
local grid = {}
...
-- | X |
-- |   |
function grid.snap_center()
  local win = window.focusedWindow()
  local s = win:screen():frame()
  grid.snap(win, (s.w*0.2)/2, (s.h*0.2)/2, s.w*0.8, s.h*0.8)
end
